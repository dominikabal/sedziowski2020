    ...
    $.dlxQuiz = function ( element, options ) {
      var plugin = this,
        ...
        defaults = {
          ...
          /* Text
           ---------------------------*/
          questionCount_text: "PYTANIE : %current_index / %totalQuestions",
          backButton_text: "POPRZEDNIE PYTANIE",
          nextButton_text: "NASTĘPNE PYTANIE",
          completeButton_text: "ZAKOŃCZ TEST",
          viewResultsButton_text: "ZOBACZ WYNIKI",
          resultsHeader_text: "ZESTAWIENIE WSZYTSKICH ODPOWIEDZI:",
          quizScore_text: "ODPOWIEDZIALES %totalScore/%totalQuestions POPRAWNYCH ODPOWIEDZI",
      ...
      plugin.method = {
        ...
        randomizeArray: function ( array ) {
          ...
          // While there remain elements to shuffleĂÂ˘Ă˘âÂŹĂÂŚ
          while ( m ) {
  
            // Pick a remaining elementĂÂ˘Ă˘âÂŹĂÂŚ
        ...
        resultsButton: function () {
          $( _quizViewResultsButton ).on( 'click', function () {
            ...
            $.each( questions, function ( index ) {
              ...
              if ( !questions[ index ].answerCorrect ) {
                //display user answer
                resultsHTML += '<strong>Twoja odpowiedź: </strong>';
                resultsHTML += questions[ index ].selected + '<br>';
              }
              //display correct answer
              resultsHTML += '<strong>Poprawna odpowiedź: </strong>';
